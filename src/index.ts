//Функция добавляет новую запись в таблицу

function formTable(selector:any){
    var wrapper = document.querySelector(selector);
    var form = wrapper.getElementsByTagName("form")[0];
    var table = wrapper.getElementsByTagName("table")[0];
    
    form.onsubmit = function(ev:any){
      ev = ev || this;
      ev.preventDefault();
...
//Функция редактирует выбранную ячейку по клику
  function  Red(){
...
//Функция удаляет записи с таблицы
function Del() {
